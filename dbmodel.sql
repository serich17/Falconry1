...
ALTER TABLE player ADD COLUMN marker INT DEFAULT 18, ADD COLUMN team INT DEFAULT NULL, ADD COLUMN team_no INT DEFAULT NULL, ADD COLUMN turn_order INT DEFAULT NULL;
