 ...
 * particular, you can set here the values of variables elements defined in falconry_falconry.tpl (elements
...
class view_falconry_falconry extends game_view
{
    protected function getGameName()
    {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "falconry_falconry", "myblock" );
